...
namespace CpFarmacia2024
{
    public partial class FrmProveedor : Form
    {
        ...
        private void listar()
        {
            ...
            if (dgvLista.Columns["razonSocial"] != null) dgvLista.Columns["razonSocial"].HeaderText = "Raz�n Social";
            ...
            if (dgvLista.Columns["telefono"] != null) dgvLista.Columns["telefono"].HeaderText = "Tel�fono";

            // Habilitar o deshabilitar botones seg�n si hay registros
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialog =
                MessageBox.Show($"�Est� seguro que desea dar de baja al proveedor con N� de documento {documento}?",
