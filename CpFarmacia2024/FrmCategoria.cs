...
namespace CpFarmacia2024
{
    public partial class FrmCategoria : Form
    {
        ...
        public void listar()
        {
            ...
            dgvListaCategoria.Columns["descripcion"].HeaderText = "Descripci�n";
        ...
        private bool validar()
        {
            ...
            {
                esValido = false;
                erpDescripcionCategoria.SetError(txtDescripcionCategoria, "El campo descripci�n es obligatorio");
            }
            return esValido;
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                ...
                if (esNuevo)
                {
                    ...
                    {
                        MessageBox.Show("NO SE PUEDE AGREGAR, descripci�n ya existente.", ":::Farmacia - Mensaje :::",
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("NO SE PUEDE ACTUALIZAR, descripci�n ya existente.", ":::Farmacia - Mensaje :::",
                            MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialog =
                MessageBox.Show($"�Est� seguro que desea dar de baja la Categoria con descripci�n {descripcion}?",
